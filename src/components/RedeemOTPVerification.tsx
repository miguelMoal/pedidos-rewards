...
export function RedeemOTPVerification({ onBack, onVerified, customerPhone }: RedeemOTPVerificationProps) {
  ...
  return (
    <div className="h-screen bg-[#f8f9fa] flex flex-col overflow-hidden">
      {/* Header */}
      <div className="bg-white border-b border-gray-100 px-6 py-3 px-[24px] py-[16px]">
      ...
      <div className="flex-1 overflow-hidden">
        <div className="max-w-7xl mx-auto p-3 h-full">
            ...
            <div className="col-span-7 flex flex-col items-center justify-center">
              <div className="w-full max-w-lg">
                <div className="bg-white rounded-[16px] border border-gray-200 shadow-sm text-center p-[24px]">
                  ...
                  {error && (
                    <div className="bg-red-50 border-2 border-red-200 rounded-[14px] p-3 mb-4">
